...
def run():
    ...
    argparser.add_argument('-feature_folder', nargs='?', help='Path to folder where to store and search for biosaur2 features .tsv files', type=str, default='', const='')
    ...
    argparser.add_argument('-top_leaders_fasta', nargs='?', help='Path to save .fasta with proteins of the most presented organisms in sample', type=str, default='', )
    ...
    ##############
    argparser.add_argument('-num_top_spec', nargs='?', help='--', default=15, type=float, const=15)
