...
def run():
    ...
    argparser.add_argument('-exclude_sp_uncul', nargs='?', help="Exclude sp. and uncultured. organisms (0 - no exclusion, 1 - exclude)", default=0, type=int, choices=[0, 1], const=0)
    ...
    argparser.add_argument('-taxid_group', nargs='?', help="taxid level to filter organisms found in blind search, availible options: 'OX', 'genus', 'family', 'order', 'class', 'phylum', 'kingdom', 'domain' (default: 'OX')", default='OX', type=str, const='OX')
